...
function library:AddWindow(title, options)
    ...
    --[[ CUSTOM UI: Create panels using provided design ]]
    ...
    -- Create main panel
    local MainPanel = {}
    local MainSize = UDim2.fromScale(0.40, 0.75)
    local MainPos = UDim2.fromScale(0.5, 0.54)
    
    -- Shadow
    MainPanel.Shadow = Instance.new("Frame")
    MainPanel.Shadow.Name = "WindowShadow_" .. windows
    MainPanel.Shadow.AnchorPoint = Vector2.new(0.5, 0.5)
    MainPanel.Shadow.Position = MainPos + UDim2.new(0, 0, 0, 8)
    MainPanel.Shadow.Size = MainSize
    MainPanel.Shadow.BackgroundColor3 = Color3.fromRGB(0,0,0)
    MainPanel.Shadow.BackgroundTransparency = 0.5
    MainPanel.Shadow.BorderSizePixel = 0
    MainPanel.Shadow.ZIndex = 1
    MainPanel.Shadow.Parent = windowsFrame
    Instance.new("UICorner", MainPanel.Shadow).CornerRadius = UDim.new(0, 20)
    
    -- Main frame
    MainPanel.Frame = Instance.new("Frame")
    MainPanel.Frame.Name = "WindowFrame_" .. windows
    MainPanel.Frame.AnchorPoint = Vector2.new(0.5, 0.5)
    MainPanel.Frame.Position = MainPos
    MainPanel.Frame.Size = MainSize
    MainPanel.Frame.BackgroundColor3 = Color3.fromRGB(255,255,255)
    MainPanel.Frame.BackgroundTransparency = 0.15
    MainPanel.Frame.BorderSizePixel = 0
    MainPanel.Frame.Parent = windowsFrame
    Instance.new("UICorner", MainPanel.Frame).CornerRadius = UDim.new(0, 20)
    ...
    marble.Parent = MainPanel.Frame
    Instance.new("UICorner", marble).CornerRadius = UDim.new(0, 20)
    
    -- Side panel for tabs
    local SideWidth = 0.15
    local SideHeight = 0.75
    local Gap = 0.025
    local SideX = (0.5 - 0.40/2) - Gap - SideWidth/2
    ...
    -- Side shadow
    SidePanel.Shadow = Instance.new("Frame")
    SidePanel.Shadow.Name = "SideShadow_" .. windows
    SidePanel.Shadow.AnchorPoint = Vector2.new(0.5, 0.5)
    SidePanel.Shadow.Position = SidePos + UDim2.new(0, 0, 0, 8)
    SidePanel.Shadow.Size = SideSize
    SidePanel.Shadow.BackgroundColor3 = Color3.fromRGB(0,0,0)
    SidePanel.Shadow.BackgroundTransparency = 0.5
    SidePanel.Shadow.BorderSizePixel = 0
    SidePanel.Shadow.ZIndex = 1
    SidePanel.Shadow.Parent = windowsFrame
    Instance.new("UICorner", SidePanel.Shadow).CornerRadius = UDim.new(0, 20)
    
    -- Side frame
    SidePanel.Frame = Instance.new("Frame")
    SidePanel.Frame.Name = "SideFrame_" .. windows
    SidePanel.Frame.AnchorPoint = Vector2.new(0.5, 0.5)
    SidePanel.Frame.Position = SidePos
    SidePanel.Frame.Size = SideSize
    SidePanel.Frame.BackgroundColor3 = Color3.fromRGB(255,255,255)
    SidePanel.Frame.BackgroundTransparency = 0.15
    SidePanel.Frame.BorderSizePixel = 0
    SidePanel.Frame.Parent = windowsFrame
    Instance.new("UICorner", SidePanel.Frame).CornerRadius = UDim.new(0, 20)
    ...
    sideStroke.Parent = SidePanel.Frame
    
    local sideGradient = gradient:Clone()
    sideGradient.Parent = SidePanel.Frame
    
    local sideMarble = marble:Clone()
    sideMarble.Parent = SidePanel.Frame
    ...
    -- Create tabs container (in main panel)
    ...
    -- Store references for original logic to use
    local window_data = {}
    local Window = MainPanel.Frame
    local Tabs = TabsContainer
    local TabButtons = TabButtonsContainer
    
    do -- UI Elements (preserving all original logic)
        do -- Add Tab
            function window_data:AddTab(tab_name)
                ...
                do -- Tab Elements (all original functions preserved)
                    ...
                    function tab_data:AddButton(button_text, callback)
                        ...
                        button.BackgroundColor3 = options.main_color
                        button.BorderSizePixel = 0
                    ...
                    function tab_data:AddSlider(slider_text, callback, slider_options)
                        ...
                        indicator.BackgroundColor3 = options.main_color
                    ...
                    function tab_data:AddConsole(console_options)
                        ...
                        do -- Syntax highlighting (preserved exactly)
                            ...
                            -- (All syntax highlighting functions preserved as-is from original)
                            -- For brevity, these remain identical to the original implementation
                        end
